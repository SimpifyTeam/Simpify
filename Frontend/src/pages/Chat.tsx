...
const FilePreview: React.FC<FilePreviewProps> = ({ file, onRemove }) => {
  ...
  return (
    <div className="relative group">
      <div className="overflow-hidden hover:scale-105 hover:shadow-lg">
        <div className="p-3">
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="flex pt-14">
        {sidebarOpen && (
          <aside className="w-64 fixed left-0 top-14 bottom-0 bg-gray-50 dark:bg-gray-800 border-r border-gray-200">
            <div className="p-4">
          ...
          >
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
              <label className="p-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg">
